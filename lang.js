...
(function () {
  ...
  var EN = {
    ...
    "Zapisz cały projekt (ze zdjęciami i fontami) do pliku": "Save the whole project (with images and fonts) to a file",
    "Otwórz projekt z pliku": "Open a project from a file",
    "Zapisano projekt do pliku: {n}": "Project saved to file: {n}",
    "Wczytano projekt: {n}": "Project loaded: {n}",
    "Wczytano projekt (fontów nie zapisano — za mało miejsca).": "Project loaded (fonts not saved — not enough space).",
    "Błędny plik projektu": "Invalid project file",
    "To nie jest plik projektu Clamy": "This is not a Clama project file",
    "Za mało miejsca w przeglądarce — użyj „Zapisz projekt\", aby zapisać do pliku.": "Not enough browser storage — use \"Save project\" to save to a file.",
